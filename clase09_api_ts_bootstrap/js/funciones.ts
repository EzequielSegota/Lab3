...
$(function(){
    ...
    $("#btn_alert_js").on("click", function(){

        alert("click - alert");
    });

    $("#btn_alert_on").on("click", function(){
    ...
    $("#btn_alert_off").on("click", function(){
...
const APIREST:string = "http://localhost/lab_3/clase09_api_ts_bootstrap/BACKEND/apiRest/";
